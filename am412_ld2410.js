...
const device = {
    zigbeeModel: ['am412_ld2410'],
    model: 'am412_ld2410',
    vendor: 'shanyinhan',
    description: 'ptvo-firmware',
    ...
    exposes: [e.occupancy().withEndpoint('l2'),
      e.presence().withEndpoint('l3'),
],
    meta: {
        multiEndpoint: true,
        binaryEndpoints: {'l2': 'occupancy', 'l3': 'presence', }, 
    },
    endpoint: (device) => {
        return {
            l2: 2, l3: 3, l1: 1,
